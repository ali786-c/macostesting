...
function LoginForm() {
  ...
  return (
    <div className="h-screen bg-white overflow-hidden w-full max-w-full flex flex-col">
      <HeaderNavigation />
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl md:rounded-3xl shadow-xl p-4 sm:p-5 md:p-6 lg:p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4 md:space-y-6">
                ...
                <button
                  ...
                  type="submit"
                  disabled={isLoading}
                  className={`w-full py-2.5 sm:py-3 md:py-4 min-h-[44px] md:min-h-0 bg-emerald-600 hover:bg-emerald-700 active:bg-emerald-800 text-white font-semibold text-sm sm:text-base md:text-lg rounded-lg sm:rounded-xl transition-colors duration-200 touch-manipulation active:scale-95 ${isLoading ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'
                    }`}
                >
                  {isLoading ? (
